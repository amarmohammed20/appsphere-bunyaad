...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <main className="grid min-h-dvh lg:grid-cols-[1.1fr_1fr]">
      {/* Brand panel — the product speaks once, quietly, then gets out of the way. */}
      <aside className="relative hidden overflow-hidden bg-zinc-950 lg:flex lg:flex-col lg:justify-between lg:p-12">
        ...
        <div
          aria-hidden
          className="breathe absolute -top-32 -left-32 h-96 w-96 rounded-full bg-white/10 blur-3xl"
        />
      ...
      <section className="flex items-center justify-center bg-zinc-50 px-4 py-12 dark:bg-zinc-950">
        <div className="w-full max-w-sm">
          <p className="rise mb-10 text-center text-sm font-semibold tracking-[0.3em] text-zinc-400 uppercase lg:hidden dark:text-zinc-500">
            Bunyaad
          </p>
          {children}
        </div>
